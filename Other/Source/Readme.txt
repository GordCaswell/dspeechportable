...
user in an INI file next to DSpeechPortable.exe called DSpeechPortable.ini. If
...
AppNamePortable.ini from this directory to DSpeechPortable.ini next to
DSpeechPortable.exe. The options in the INI file are as follows:
